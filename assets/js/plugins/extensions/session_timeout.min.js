	...
	jQuery.sessionTimeout=function(b){
		...
		function d(){
			...
			function e(){
				clearTimeout(f),
				f=setTimeout(function(){
					"function"!=typeof h.onRedir?(e("start"),
						window.location=h.redirUrl):h.onRedir()
				},
