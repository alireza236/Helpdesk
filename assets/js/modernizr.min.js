 ...
 * http://modernizr.com/download/?-canvas-setclasses !*/
!function(e,n,t){
	function s(e,n){
		return typeof e===n
	}
	function a(){
		...
		for(var c in l)
			if(l.hasOwnProperty(c)){
				if(e=[],n=l[c],n.name&&(e.push(n.name.toLowerCase()),
					n.options&&n.options.aliases&&n.options.aliases.length))
					for(t=0;t<n.options.aliases.length;t++)e.push(n.options.aliases[t].toLowerCase());
						for(a=s(n.fn,"function")?n.fn():n.fn,o=0;o<e.length;o++)i=e[o],f=i.split("."),
							1===f.length?Modernizr[f[0]]=a:(!Modernizr[f[0]]||Modernizr[f[0]]instanceof Boolean||(Modernizr[f[0]]=new Boolean(Modernizr[f[0]])),
								Modernizr[f[0]][f[1]]=a),
						r.push((a?"":"no-")+f.join("-"))
					}
				}
							...
							on:function(e,n){
								...
								addTest:function(e,n,t){
									...
									addAsyncTest:function(e){
										...
										a(),
										o(r),
										delete f.addTest,delete f.addAsyncTest;
