...
// $config['include_home'] will tell the library if the first element should be the homepage. 

//You only put the title of the first crumb. If you leave it blank it will not put homepage as first crumb
