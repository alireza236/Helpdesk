            <div class="panel panel-flat">
                <a class="btn btn-primary bg-success-800" href="<?= base_url('public/headline_news/addnews'); ?>"><span><i class="icon-plus-circle2"></i> Tambah Data</span></a>
...
<script type="text/javascript" charset="utf-8">
  $(function() {
    ...
    $('.datatable-tools').DataTable({
        ...
        processing: true,
        ajax :{
           'url' : '<?php echo base_url() ?>public/headline_news/getjson',
           'type' : 'POST',
         }
    });
