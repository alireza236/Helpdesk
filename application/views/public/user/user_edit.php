							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<fieldset>
										...
										<div class="collapse in" id="demo1">
											<div class="form-group">
		                                        ...
		                                        <input type="text" name="fullname" class="form-control" value="<?php echo $fullname; ?>" placeholder="masukan nama lengkap" readonly>
											...
											<div class="form-group">
												<label>Level:</label>
			                                    <select name="level" value="<?php echo $level; ?>" data-placeholder="pilih level user" class="form-control select">
									...
									<div class="text-right">
										...
										<a href="<?php echo site_url('public/users') ?>" class="btn btn-default">Cancel</a>
									</div>
								</div>
							</div>
						</form>
