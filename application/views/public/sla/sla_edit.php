						...
						<div class="panel-body">
							<div class="row">
                                ...
                                <div class="form-group">
											<label class="col-lg-3 control-label">SLA ID:</label>
											<div class="col-md-6">
                                        <div class="form-control-static"><b> <?php echo $slaid; ?></b></div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
														<div class="mb-10">
						<select data-placeholder="" name="responsetime" value="<?php echo $responsetime; ?>" class="form-control select">
						     <option value="<?php echo $responsetime; ?>"><?php echo $responsetime; ?></option>
                              <script> 
                                for (var i=1;i<=24;i++){
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
														<div class="mb-10">
			<select data-placeholder="" name="resolutiontime" value="<?php echo $resolutiontime; ?>" class="form-control select">
			    <option value="<?php echo $resolutiontime; ?>"><?php echo $resolutiontime; ?></option>
                  <script> 
                     for (var i=1;i<=999;i++){
                  	   document.write("<option value=" + i + ">" + i + "</option>");}
				 </script>
								...
								<label class="col-lg-3 control-label">Masa Tenggang SLA <b><i>(dalam jam)</i></b> :</label>
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
														<div class="mb-10">
       <select data-placeholder="" name="slawarning" value="<?php echo $slawarning; ?>" class="form-control select">
            <option value="<?php echo $slawarning; ?>"><?php echo $slawarning; ?></option>
            <script> 
				for (var i=1;i<=999;i++){
					document.write("<option value=" + i + ">" + i + "</option>");}
			</script>                   
