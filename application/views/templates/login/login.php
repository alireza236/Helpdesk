...
<body class="bg-slate-800" onload="document.userform.username.focus();">
	...
	<div class="page-container login-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<!--==== Advanced login ====-->
				<form action="<?= base_url('login'); ?>" method="post" name="userform"  onsubmit="return login();">
					<div class="panel panel-body login-form">
						...
						<div class="text-center">
							...
							<div class="content-divider text-muted form-group"><span><small class="display-block">Enter your credentials</small></span></div>
						</div>
   ...
   <!-- Theme JS files -->
	...
	<script type="text/javascript" src="<?= base_url('assets')?>/js/plugins/forms/validation/validation.min.js"></script>
