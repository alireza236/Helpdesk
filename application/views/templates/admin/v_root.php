...
<body onload="return startTime()">
	...
	<script type="text/javascript" src="<?= base_url('assets'); ?>/js/plugins/footable/footable.min.js"></script>
	...
	<script type="text/javascript" src="<?= base_url('assets'); ?>/js/plugins/tables/datatables/extensions/col_vis.min.js"></script>
